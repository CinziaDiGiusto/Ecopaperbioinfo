...
\abstract{
This paper studies discrete models of ecosystems viewed as collections of interacting living (animals, plants\ldots ) and nonliving entities (air, water, soil\ldots ), whose conditions of appearance/disappearance are controlled by a set of formal rules (i.e. processes). In ecology, it remains today a challenge to identify indirect interactions at play in ecosystem responses. 
We present a rule-based method allowing to automatically detect patterns (i.e., ecological processes or sets of processes) in  ecosystem. The method relies on a measure of similarity and on an optimization algorithm. 
}
