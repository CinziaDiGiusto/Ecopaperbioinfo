...
%
\title{Pattern Matching in Qualitative Models for Ecosystem Ecology}
...
\abstract{
In this paper we consider discrete qualitative models of ecosystems viewed as collections of interacting living (animals, plants\ldots ) and nonliving entities (air, water, soil\ldots ), whose conditions of appearance/disappearance are controlled by a set of formal rules (i.e., processes). 
